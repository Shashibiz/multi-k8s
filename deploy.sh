...
kubectl set image deployments/client-deployment server=sha01/multi-client:$SHA
kubectl set image deployments/worker-deployment server=sha01/multi-worker:$SHA